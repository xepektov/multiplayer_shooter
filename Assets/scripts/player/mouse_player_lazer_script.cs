...
public class mouse_player_lazer_script : MonoBehaviour
{

    [SerializeField] LayerMask lazer_layer1,lazer_layer;
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Mouse2) && (cooldown_bar > overheat_rate))
        {
        ...
        //xcooldown_circle.fillAmount = cooldown_bar / cooldown_max;
    ...
    void shoot_lazer()
    {
        ...
        if (Physics.Raycast(transform.position, transform.TransformDirection(Vector3.forward), out RaycastHit hitinfo1, lazer_length,lazer_layer))
        {
