...
public class Bullet : MonoBehaviour
{
	...
	public void Setup(Vector3 dir, PhotonView from)
	{
		...
		m_rigidbody.AddRelativeForce(dir * m_force, m_forceMode);
	}

	private void OnTriggerEnter(Collider other)          //i'm setiing the billet collider to trigger instead from collider
	{
